...
local client_fns = require "config.keybindings.client"
local global_fns = require "config.keybindings.global"
local launcher_fns = require "config.keybindings.launcher"
local layout_fns = require "config.keybindings.layout"
local media_fns = require "config.keybindings.media"
local mouse_bindings = require "config.keybindings.mouse"
local screen_fns = require "config.keybindings.screen"
local tag_fns = require "config.keybindings.tags"
...
local global_keys = {
  ...
  {{ modkey },        "d",                     launcher_fns.noscope,             "noscope",                               "layout"  },
