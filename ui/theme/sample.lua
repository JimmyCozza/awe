-- INFO: This is the sample theme file provided by the awesomewm docs:
-- https://awesomewm.org/apidoc/documentation/06-appearance.md.html
-- This is a pretty good place to start for a new theme.  Copy/paste
-- this file and start setting the values the new theme should have.
local theme = {}
